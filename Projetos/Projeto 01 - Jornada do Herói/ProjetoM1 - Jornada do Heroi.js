...
console.log(
  `Olá, ${nomeheroi}. Sua jornada em busca da espada Tibianus está prestes a começar.`
);
console.log(
  "Durante sua aventura, você irá tomar decisões que lhe ajudarão a chegar ao seu objetivo."
);
...
if (iniciojornada === "sim") {
  console.log(
    "A lenda nos conta que a espada Tibianus, uma espada que possui um grande poder,"
  );
  console.log(
    "está localizada dentro das muralhas do castelo de Gorgon e está sendo vigiada por"
  );
  console.log(
    "uma criatura abominável! Apenas um cavaleiro(a) de coração puro conseguirá resgatar a espada."
  );
  prompt("");
  ...
  console.log();
  console.log(
    "Entendido. Devemos seguir com cautela pois estamos em uma área desconhecida."
  );
  prompt("");
  console.log(
    "Meu Deus! Que barulho estranho é esse? Atenção e continue na surdina."
  );
  prompt("");
  console.log();
  console.log("CUIDADO!");
  ...
  console.log(
    "Observe a passagem ao lado das muralhas do castelo, vamos entrar!"
  );
  ...
  if (qnt == 5) {
    ...
    console.log(
      `${nomeheroi}, depois de muito esforço você conquistou seu objetivo.`
    );
    console.log("Embora não de maneira perfeita.");
  } else if (qnt == 3) {
    console.log(
      `${nomeheroi}, você chegou perto de conseguir alcançar seu objetivo.`
    );
    ...
    console.log(
      `${nomeheroi}, suas escolhas te levaram a falhar miseravelmente.`
    );
  }
} else {
  console.log(
    `Que pena, ${nomeheroi}! Te esperamos novamente para o inicio de uma nova jornada.`
  );
}
